...
public class QuizManipulationImpl implements QuizManipulation {
    private static final Logger logger = LogManager.getLogger(QuizManipulation.class);
    ...
    public void addQuestion(QuizSection quizSection) {
        try{
            ...
            if(questionNumber>quizSection.getAllQuestion().size() || questionNumber<=0)
            {
    ...
    public void updateExistingQuestion(QuizSection quizSection) {
        try{
            ...
            if(quizSection.getAdminQuestionList().contains(questionNumber)
                    && (updateQuestionNumber>=1 && updateQuestionNumber<=quizSection.getAllQuestion().size()))
                {
    ...
    public void addNewQuestionToDB(QuizSection quizSection) {
        ...
        quizSection.addNewQuestionToDB(question1);
