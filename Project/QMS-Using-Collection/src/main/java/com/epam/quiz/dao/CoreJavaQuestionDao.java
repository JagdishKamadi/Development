...
import com.epam.quiz.db.CoreJavaQuestionDB;
...
public class CoreJavaQuestionDao implements QuizSection{
    public Map<Integer, Question> getSectionQuestion()
    {
        return CoreJavaQuestionDB.questionAnswerMap;
    }
    public Map<Integer, QuestionTag> getSectionQuestionTag()
    {
        return CoreJavaQuestionDB.questionTagMap;
    }

    public List<Integer> getAdminQuestionList()
    {
        return CoreJavaQuestionDB.questionNumberListByAdmin;
    }

    public void setAdminQuestionList(int questionNumber)
    {
        CoreJavaQuestionDB.questionNumberListByAdmin.add(questionNumber);
    }
    ...
    {
        return CoreJavaQuestionDB.questionNumberListByAdmin.size()>0 ? CoreJavaQuestionDB.questionNumberListByAdmin : RandomNumber.getQuestionNumberList();
    }
