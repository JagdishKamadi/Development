...
@ExtendWith({MockitoExtension.class})
 class SectionServiceImplTest {
    ...
    @Test
    void test_getSectionNameNumberListPass()
    {
        when(questionRepository.findBySectionTag(SectionTag.valueOf("CORE_JAVA"))).thenReturn(new ArrayList<Question>());
        assertNotNull(sectionService.getSectionQuestionIDList("CORE_JAVA"));
    }

    @Test
    void test_getSectionNameNumberListFail()
    {
        when(questionRepository.findBySectionTag(SectionTag.valueOf("CORE_JAVA"))).thenThrow(IllegalArgumentException.class);
        assertThrows(IllegalArgumentException.class,()->sectionService.getSectionQuestionIDList("CORE_JAVA"));
    }
