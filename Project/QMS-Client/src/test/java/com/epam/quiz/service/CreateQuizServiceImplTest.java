...
@ExtendWith(MockitoExtension.class)
 class CreateQuizServiceImplTest {
   ...
   private QuestionRepository questionRepository;
    ...
    @Test
    void generateQuestionNumberList()
    {

        when(sectionService.getSectionNameNumberList(anyString())).thenReturn(Arrays.asList(1,2,3,3,4,5,5));
//        when(RandomNumber.getQuestionNumberList(any(ArrayList.class))).thenReturn(Set.of(1,2,3,3,4,5,5));
    ...
    @Test
    void createQuestionListBySectionNamePassTest()
    {
        ...
        //        when(createQuizService.generateQuestionNumberList(anyString())).thenReturn(Set.of(1,2,3,3,4,5,5));
    }
